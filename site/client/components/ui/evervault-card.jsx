  ...
  return (
    ...
    >
      <div
        ...
        className="group/card rounded-3xl w-full relative overflow-hidden bg-black flex items-center justify-center h-full shadow-[0_0_20px_0_rgba(14,165,233,0.3)]"
      >
        <CardPattern
          mouseX={mouseX}
          mouseY={mouseY}
...
export function CardPattern({ mouseX, mouseY, randomString }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-sky-500 to-blue-700 opacity-40 group-hover/card:opacity-100 backdrop-blur-xl transition duration-500"
        style={style}
      />
      <motion.div
